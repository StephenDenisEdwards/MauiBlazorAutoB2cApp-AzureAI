...
using MauiBlazorAutoB2cApp.Services;
...
public static class MauiProgram
{
	...
	//public static MauiApp CreateMauiApp()
	{
		...
		*/
		...
		// Add device-specific services used by the MauiBlazorAutoB2cApp.Shared project
...
#if ANDROID
	   builder.Services.AddSingleton<IParentWindowProvider, MauiBlazorAutoB2cApp.Android.ParentWindowProvider>();
#elif IOS
    builder.Services.AddSingleton<IParentWindowProvider, MauiBlazorAutoB2cApp.iOS.ParentWindowProvider>();
#elif WINUI
    builder.Services.AddSingleton<IParentWindowProvider, MauiBlazorAutoB2cApp.Platforms.Windows.ParentWindowProvider>();
#elif WINDOWS
    builder.Services.AddSingleton<IParentWindowProvider, MauiBlazorAutoB2cApp.Platforms.Windows.ParentWindowProvider>();
#endif
		...
		//else if (DeviceInfo.Current.Platform == DevicePlatform.WinUI)
		//{
		//builder.Services.AddSingleton<IParentWindowProvider, MauiBlazorAutoB2cApp.WinUi.ParentWindowProvider>();
		//}
